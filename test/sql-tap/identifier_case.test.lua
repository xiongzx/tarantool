...
data = {
    ...
    { 4,  [["bInaRy"]], {0}},
    { 5,  [["unicode"]], {0}},
    { 6,  [[ unicode ]], {1,"Failed to execute SQL statement: Collation 'UNICODE' does not exist"}},
    { 7,  [["UNICODE"]], {1,"Failed to execute SQL statement: Collation 'UNICODE' does not exist"}}
}
